          ...
          <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
            <div className="relative w-auto my-6 mx-auto max-w-3xl">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none min-h-[600px] max-h-[600px]">
                {/*header*/}
                <div className="flex items-start justify-between text-slate-700 p-5 bg-gradient-to-b from-sky-300 to bg-slate-100 border-b border-solid border-slate-200 rounded-t">
                  <h3 className="text-3xl font-semibold">
                    Hasil : {rupiah(+result)}
                  </h3>
                </div>
                {/*body*/}
                <div className="relative p-6 flex-auto bg-slate-100 overflow-auto min-w-[40rem] max-sm:min-w-[20rem]">
                  {listMoney &&
                ...
                {/*footer*/}
                <div className="flex items-center justify-end p-6 bg-gradient-to-b from-white to bg-blue-300 border-t border-solid border-slate-200 rounded-b">
                  <button
